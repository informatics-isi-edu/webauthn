...
class StressTest:
    def __init__(self, host, credential_map, catalog_number, ermrest_path,
                 ermrest_min, ermrest_max):
        self.host = host
...
if __name__ == '__main__':
    ...
    test_obj = StressTest(args.host, credential_map, args.catalog_number, args.ermrest_path,
                          args.ermrest_min, args.ermrest_max)
    test_obj.run_many(args.threads_per_session, args.iterations_per_thread, args.sleeptime)
